...
import { getCurrentWeatherData, getDaysForecastData, getNewsArticles } from '../utils';
        ...
        <>
            <div className='flex mx-auto gap-16'>
                ...
                <div className="flex flex-1 ">
                    ...
                    <button className="flex items-center p-3 border rounded-r-lg hover:bg-gray-400 bg-gray-50" onClick={handleSearch}>
                ...
                <button className="flex items-center p-3 border rounded-lg bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40  border-gray-100" onClick={handleSearch}>
